...
if __name__ == "__main__":
            ...
            if filename.endswith('pp'):
                ...
                with open(file_path,'rb') as f:
                    try:
                        ...
                        pp = pickle.load(f, encoding='bytes')
                        pp = np.asarray(pp)
    ...
    with open("data.pickle", 'wb') as f:
        ...
        #f.write(pickle.dumps(data.values()))
        #f.write(pickle.dump(data.values(),protocol = pickle.HIGHEST_PROTOCOL))
        pickle.dump(list(data.values()),f)#,pickle.HIGHEST_PROTOCOL)

    with open("label.pickle", 'wb') as f:
        pickle.dump(array(labels),f,pickle.HIGHEST_PROTOCOL)
